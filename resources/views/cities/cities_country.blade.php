...
@section('title', 'Cidades de um país')
...
@section('content')
    ...
    <div class="row">
        ...
        <h3 class="text-center mt-3 titulo">Cidades do País - {{$country->name}}</h3>
            ...
            <div style="clear:both;" class="card mt-3">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center">Não há nenhuma cidade registrada neste País!</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
